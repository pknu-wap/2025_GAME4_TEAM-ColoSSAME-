...
namespace BattleK.Scripts.Manager
{
    ...
    public class StatAdaptManager : MonoBehaviour
    {
        ...
        private Dictionary<string, CharacterStatsRow> _byUnitId;   // key: Unit_ID (원본)
        private Dictionary<string, CharacterStatsRow> _byUnitName; // key: Unit_Name (보조, 소문자 trim)
        ...
        private static bool TryGetAPS(CharacterStatsRow row, out float aps)
        {
            aps = 0f;
